...
class StemTranspose(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = nn.ConvTranspose2d(in_channels, 64, kernel_size=7, stride=2, padding=3, bias=False)  # 1 / 2 [112, 112]
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        x_cam1 = F.relu(x_cam1, inplace=True)
        ...
        x_cam2 = F.relu(x_cam2, inplace=True)
        ...
        for i in range(2, self.fin_stage):
            ...
            if i % 4 == 0:
                ...
                x_cam = F.relu(x_cam, inplace=True)
                x_cams.append(x_cam)
